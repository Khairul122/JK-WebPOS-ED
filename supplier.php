                ...
                <div class="container-fluid">
                    <div class="row my-4">
                        <div class="col-lg-1 pr-1">
                            <a href="supplier_insert.php" class="btn btn-success btn-block">+ Insert</a>
                        </div>
                        <div class="col-lg-1 px-1">
                            <a href="supplier_hapus.php" class="btn btn-primary btn-user btn-block">Hapus</a>
                        </div>
                    </div>
                    <!-- DataTales Example -->
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Nama Toko</th>
                                            <th>Nama Sales</th>
                                            <th>Sales No HP / Telp</th>
                                            <th>Aksi</th>
                                        </tr>
                                        <?php
                                        $no = 1;
                                        $data3 = mysqli_query($config, "SELECT * FROM tbl_supplier ");
                                        while ($row3 = mysqli_fetch_array($data3)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>$nama_toko</td>
                                                <td>$nama_sales</td>
                                                <td>$supplier_no_hp</td>
                                                <td>
                                                    <a href='supplier_update.php?supplier_id=$supplier_id' class='btn btn-danger btn-user btn-block'>Update</a>
                                                    <a href='supplier_hapus_satuan.php?supplier_id=$supplier_id' class='btn btn-primary btn-user btn-block'>Hapus</a>
                                                </td>
                                            </tr>
                                            ";
                                            $no++;
