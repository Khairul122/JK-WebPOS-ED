...
('PRDK001', 'PENGLENGKAPAN BAYI', 'Pampers', 'Pampers Premium Care', 45, 95000, 100000, 'pak'),
...
(91, 'TRNSKS000000091', '2024-09-10 04:09:31', 'PLGGN00001', 'PRDK001', 1, 95000, 100000, 120000, 20000, 0, 'Admin');
...
--
ALTER TABLE `tbl_keranjang`
  MODIFY `keranjang_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
