    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            <div class="container-fluid">
                ...
                <hr>
                <h5 class="text-center mb-3">Laporan Penjualan Perhari</h5>
                ...
                $queryConditions = "";
                if (isset($_POST["tanggal_pilih"])) {
                    $tanggal_pilih = date("d-m-Y", strtotime($_POST["tanggal_pilih"]));
                    $queryConditions = "WHERE DATE_FORMAT(tgl_wktu_transaksi, '%d-%m-%Y') = '$tanggal_pilih'";
                }
