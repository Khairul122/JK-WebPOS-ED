            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <h1 class="h3 mb-4 text-black">+ Supplier Insert</h1>
                    </div>
                        ...
                        <div class='row'>
                            <div class='col-lg-12'>
                                <div class='form-group'>
                                    ...
                                    <input type='number' name='supplier_no_hp' class='form-control'>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
...
if (isset($_POST["submit_i"])) {
    ...
    $submit_i = mysqli_query($config, "INSERT INTO tbl_supplier VALUES('','$nama_toko','$nama_sales','$supplier_no_hp')");
    echo '<script>alert("Supplier Insert");window.location="supplier.php"</script>';
}
?>