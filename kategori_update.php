        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <?php
                    $data3 = mysqli_query($config, "SELECT * FROM tbl_kategori WHERE kategori_id='$_GET[kategori_id]' ");
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <h1 class="h3 mb-4 text-black">Kategori Update</h1>
                    </div>
                        ...
                        <div class='row'>
                            <div class='col-lg-12'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='kategori_id' value="<?= $kategori_id ?>" readonly class='form-control'>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-lg-12'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='kategori_nama' value="<?= $kategori_nama ?>" class='form-control'>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
...
if (isset($_POST["submit_u"])) {
    ...
    $submit_u = mysqli_query($config, "UPDATE tbl_kategori SET kategori_nama='$kategori_nama' WHERE kategori_id='$kategori_id' ");
    echo '<script>alert("Kategori Update");window.location="kategori.php"</script>';
}
?>