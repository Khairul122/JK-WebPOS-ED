        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <?php
                        $data3 = mysqli_query($config, "SELECT * FROM tbl_kategori");
                        while ($row3 = mysqli_fetch_array($data3)) {
                            $kategori_id  = $row3["kategori_id"];
                            $kategori_nama = $row3["kategori_nama"];
                            echo
                            "
            ...
            <li class="nav-item">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="laporan_karyawan.php" target="_blank">Laporan Karyawan</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Pendapatan Penjualan Hari Ini</div>
                                            <?php
                                            $date = date("d/m/Y");
                                            echo "$date";
                                            $data4 = mysqli_query($config, "SELECT sum(total_harga) as total_harga FROM tbl_transaksi WHERE tgl_wktu_transaksi LIKE '%$date%'");
                                            while ($row4 = mysqli_fetch_array($data4)) {
                                                $total_harga = $row4["total_harga"];
                                                if ($total_harga == NULL) {
                                                    $total_harga1 = "Belum Ada Barang Terjual";
                                                } else {
                                                    $total_harga1 = number_format($total_harga, 0);
                                                }
                                            }
                                            ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo "Rp.$total_harga1" ?></div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Pendapatan Penjualan Bulan Ini</div>
                                            <?php
                                            $date = date("m/Y");
                                            echo "$date";
                                            $data6 = mysqli_query($config, "SELECT sum(total_harga) as total_harga FROM tbl_transaksi WHERE tgl_wktu_transaksi LIKE '%$date%'");
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Pendapatan Penjualan Tahun Ini</div>
                                            <?php
                                            $date = date("Y");
                                            echo "$date";
                                            $data6 = mysqli_query($config, "SELECT sum(total_harga) as total_harga FROM tbl_transaksi WHERE tgl_wktu_transaksi LIKE '%$date%'");
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Keuntungan Penjualan Hari Ini</div>
                                            <?php
                                            $date = date("d/m/Y");
                                            echo "$date";
                                            $data6 = mysqli_query($config, "SELECT sum(total_harga_m) as total_harga_m,sum(total_harga) as total_harga FROM tbl_transaksi WHERE tgl_wktu_transaksi LIKE '%$date%'");
                                            while ($row6 = mysqli_fetch_array($data6)) {
                                                $total_harga_m =  $row6["total_harga"] - $row6["total_harga_m"];
                                                if ($total_harga_m == NULL) {
                                                    $total_harga1 = "Belum Ada Barang Terjual";
                                                } else {
                                                    $total_harga1 = number_format($total_harga_m, 0);
                                                }
                                            }
                                            ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo "Rp. $total_harga1" ?></div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Keuntungan Penjualan Bulan Ini</div>
                                            <?php
                                            $date = date("m/Y");
                                            echo "$date";
                                            $data6 = mysqli_query($config, "SELECT sum(total_harga_m) as total_harga_m,sum(total_harga) as total_harga FROM tbl_transaksi WHERE tgl_wktu_transaksi LIKE '%$date%'");
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Keuntungan Penjualan Tahun Ini</div>
                                            <?php
                                            $date = date("Y");
                                            echo "$date";
                                            $data6 = mysqli_query($config, "SELECT sum(total_harga_m) as total_harga_m,sum(total_harga) as total_harga FROM tbl_transaksi WHERE tgl_wktu_transaksi LIKE '%$date%'");
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Produk Terjualan Hari Ini</div>
                                            <?php
                                            $date = date("d/m/Y");
                                            echo "$date";
                                            $data6 = mysqli_query($config, "SELECT sum(jumlah_item) as jumlah_item FROM tbl_transaksi WHERE tgl_wktu_transaksi LIKE '%$date%'");
                                            while ($row6 = mysqli_fetch_array($data6)) {
                                                $jumlah_item =  $row6["jumlah_item"];
                                                if ($jumlah_item == NULL) {
                                                    $jumlah_item1 = "Belum Ada Barang Terjual";
                                                } else {
                                                    $jumlah_item1 = $jumlah_item;
                                                }
                                            }
                                            ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo "$jumlah_item1" ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Produk Terjualan Bulan Ini</div>
                                            <?php
                                            $date = date("m/Y");
                                            echo "$date";
                                            $data6 = mysqli_query($config, "SELECT sum(jumlah_item) as jumlah_item FROM tbl_transaksi WHERE tgl_wktu_transaksi LIKE '%$date%'");
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Produk Terjualan Tahun Ini</div>
                                            <?php
                                            $date = date("Y");
                                            echo "$date";
                                            $data6 = mysqli_query($config, "SELECT sum(jumlah_item) as jumlah_item FROM tbl_transaksi WHERE tgl_wktu_transaksi LIKE '%$date%'");
