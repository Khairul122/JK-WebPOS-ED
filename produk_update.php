            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <h1 class="h3 mb-4 text-black">Produk Update</h1>
                    </div>
                    <?php
                    $data3 = mysqli_query($config, "SELECT * FROM tbl_produk WHERE produk_id='$_GET[produk_id]'  ");
                        ...
                        <div class='row'>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' readonly name='produk_id' value="<?= $produk_id ?>" class='form-control'>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    ...
                                    <select name="produk_kategori" class='form-control'>
                                        <option value="<?= $produk_kategori ?>"><?= $produk_kategori ?></option>
                                        <option value="-">Pilih Kategori Produk</option>
                                        <?php
                                        $data4 = mysqli_query($config, "SELECT * FROM tbl_kategori ");
                                        while ($row4 = mysqli_fetch_array($data4)) {
                                            $kategori_nama = $row4["kategori_nama"];
                        ...
                        <div class='row'>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='produk_merek' value="<?= $produk_merek ?>" class='form-control'>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label>Nama Produk</label>
                                    <input type='text' name='produk_nama' value="<?= $produk_nama ?>" class='form-control'>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='produk_stok' value="<?= $produk_stok ?>" class='form-control'>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label>Harga Modal</label>
                                    <input type='text' name='produk_harga_modal' value="<?= $produk_harga_modal ?>" class='form-control'>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='produk_harga_jual' value="<?= $produk_harga_jual ?>" class='form-control'>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label>Satuan Produk</label>
                                    <input type='text' name='produk_satuan' value="<?= $produk_satuan ?>" class='form-control'>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
...
if (isset($_POST["submit_u"])) {
    ...
    $produk_merek = $_POST["produk_merek"];
    $produk_nama = $_POST["produk_nama"];
    $produk_stok = $_POST["produk_stok"];
    $produk_harga_modal = $_POST["produk_harga_modal"];
    $produk_harga_jual = $_POST["produk_harga_jual"];
    $produk_satuan = $_POST["produk_satuan"];
    $submit_u = mysqli_query($config, "UPDATE tbl_produk SET produk_kategori='$produk_kategori',produk_merek='$produk_merek',produk_nama='$produk_nama',produk_stok='$produk_stok',produk_harga_modal='$produk_harga_modal',produk_harga_jual='$produk_harga_jual',produk_satuan='$produk_satuan' WHERE produk_id='$produk_id' ");
    echo '<script>alert("Produk Update");window.location="produk.php"</script>';
}
?>