                ...
                <div class="container-fluid">
                    <div class="row my-4">
                        <div class="col-lg-1 pr-1">
                            <a href="kategori_insert.php" class="btn btn-success btn-block">+ Insert</a>
                        </div>
                        <div class="col-lg-1 px-1">
                            <a href="kategori_hapus.php" class="btn btn-primary btn-user btn-block">Hapus</a>
                        </div>
                    </div>
                    <!-- DataTales Example -->
                                    ...
                                    <thead>
                                        ...
                                        while ($row3 = mysqli_fetch_array($data3)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>$kategori_nama</td>
                                                <td>
                                                    <a href='kategori_update.php?kategori_id=$kategori_id' class='btn btn-danger btn-user btn-block'>Update</a>
                                                    <a href='kategori_hapus_satuan.php?kategori_id=$kategori_id' class='btn btn-primary btn-user btn-block'>Hapus</a>
                                                </td>
                                            </tr>
                                            ";
                                            $no++;
