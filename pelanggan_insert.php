            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <h1 class="h3 mb-4 text-black">+ Pelanggan Insert</h1>
                    </div>
                    <?php
                    $id = mysqli_query($config, "SELECT max(pelanggan_id) as pelanggan_id FROM tbl_pelanggan");
                    $data = mysqli_fetch_array($id);
                    $pelanggan_id = $data['pelanggan_id'];
                    $pelanggan_id1 = substr($pelanggan_id, 5, 5);
                    $pelanggan_id1++;
                    $pelanggan_id2 = "PLGGN" . sprintf("%05s", $pelanggan_id1);
                    ?>
                        ...
                        <div class='row'>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='pelanggan_id' value="<?= $pelanggan_id2 ?>" readonly class='form-control'>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label>Nama Pelanggan</label>
                                    <input type='text' name='pelanggan_nama' class='form-control'>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    ...
                                    <input type='number' name='pelanggan_no_hp' class='form-control'>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
...
if (isset($_POST["submit_i"])) {
    ...
    $submit_i = mysqli_query($config, "INSERT INTO tbl_pelanggan VALUES('$pelanggan_id','$pelanggan_nama','$pelanggan_no_hp')");
    echo '<script>alert("Pelanggan Insert");window.location="pelanggan.php"</script>';
}
?>
