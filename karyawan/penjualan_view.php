...
if (isset($_POST["submit_ip"])) {
    ...
    $data8 = mysqli_query($config, "SELECT * FROM tbl_produk WHERE produk_id='$produk_id' ");
    while ($row8 = mysqli_fetch_array($data8)) {
        $produk_id = $row8["produk_id"];
        $produk_stok = $row8["produk_stok"] - $jumlah_item;
        $produk_harga_jual = $row8["produk_harga_jual"] * $jumlah_item;
    }
    $submit_ip = mysqli_query($config, "INSERT INTO tbl_keranjang VALUES('','$produk_id','$jumlah_item','$produk_harga_jual')");
    $submit_up = mysqli_query($config, "UPDATE tbl_produk SET produk_stok='$produk_stok' WHERE produk_id='$produk_id' ");
...
if (isset($_POST["submit_it"])) {
    ...
    $data9 = mysqli_query($config, "SELECT * FROM tbl_keranjang ");
    while ($row9 = mysqli_fetch_array($data9)) {
        $keranjang_id = $row9["keranjang_id"];
        $produk_id = $row9["produk_id"];
        $jumlah_item = $row9["jumlah_item"];
        $total_harga = $row9["total_harga"];
        $submit_it = mysqli_query($config, "INSERT INTO tbl_transaksi VALUES($keranjang_id,'$transaksi_id','$tgl_wktu_transaksi','$pelanggan_id','$produk_id','$jumlah_item','$total_harga')");
    }
    $submit_d = mysqli_query($config, "DELETE FROM tbl_keranjang");
