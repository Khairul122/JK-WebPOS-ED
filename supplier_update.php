            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <h1 class="h3 mb-4 text-black">Supplier Update</h1>
                    </div>
                    <?php
                    $no = 1;
                    $data3 = mysqli_query($config, "SELECT * FROM tbl_supplier WHERE supplier_id='$_GET[supplier_id]' ");
                    $row3 = mysqli_fetch_array($data3); {
                        $supplier_id = $row3["supplier_id"];
                        $nama_toko = $row3["nama_toko"];
                        $nama_sales = $row3["nama_sales"];
                        $supplier_no_hp    = $row3["supplier_no_hp"];
                    }
                    ?>
                        ...
                        <div class='row'>
                            <div class='col-lg-12'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='supplier_id' value="<?= $supplier_id ?>" readonly class='form-control'>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='nama_toko' value="<?= $nama_toko ?>" class='form-control'>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label>Nama Sales</label>
                                    <input type='text' name='nama_sales' value="<?= $nama_sales ?>" class='form-control'>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-lg-12'>
                                <div class='form-group'>
                                    <label>No HP / Telp Supplier</label>
                                    <input type='number' name='supplier_no_hp' value="<?= $supplier_no_hp ?>" class='form-control'>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
...
if (isset($_POST["submit_u"])) {
    ...
    $supplier_no_hp    = $_POST["supplier_no_hp"];
    $submit_i = mysqli_query($config, "UPDATE tbl_supplier SET nama_toko='$nama_toko',nama_sales='$nama_sales',supplier_no_hp='$supplier_no_hp' WHERE supplier_id='$supplier_id'");
    echo '<script>alert("Supplier Update");window.location="supplier.php"</script>';
}
?>