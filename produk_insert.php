            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <h1 class="h3 mb-4 text-black">+ Produk Insert</h1>
                    </div>
                    <?php
                    $id = mysqli_query($config, "SELECT max(produk_id) as produk_id FROM tbl_produk");
                    $data = mysqli_fetch_array($id);
                    $produk_id = $data['produk_id'];
                    $produk_id1 = substr($produk_id, 4, 6);
                    $produk_id1++;
                    $produk_id2 = "PRDK" . sprintf("%06s", $produk_id1);
                    ?>
                        ...
                        <div class='row'>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='produk_id' value="<?= $produk_id2 ?>" readonly class='form-control'>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                        ...
                        <div class='row'>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='produk_merek' class='form-control'>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                        ...
                        <div class='row'>
                            ...
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='produk_harga_modal' class='form-control'>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='produk_harga_jual' class='form-control'>
                                </div>
                            </div>
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label>Satuan Produk</label>
                                    <input type='text' name='produk_satuan' class='form-control'>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
...
if (isset($_POST["submit_i"])) {
    ...
    $submit_i = mysqli_query($config, "INSERT INTO tbl_produk VALUES('$produk_id','$produk_kategori','$produk_merek','$produk_nama','$produk_stok','$produk_harga_modal','$produk_harga_jual','$produk_satuan')");
    echo '<script>alert("Produk Insert");window.location="produk.php"</script>';
}
?>